...
const CoachesTable = () => {
  ...
  // ✅ Fetch coaches once when component mounts
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(
        (coach) =>
          coach.name?.toLowerCase().includes(lowerSearch) ||
          coach.email?.toLowerCase().includes(lowerSearch) ||
          coach.specialization?.toLowerCase().includes(lowerSearch)
      );
    }
            ...
            <TableBody>
              {loading ? (
                ...
                filteredCoaches
                  ...
                  .map((coach) => (
                    <TableRow hover role="checkbox" key={coach._id}>
                      <TableCell>
                        <Avatar
                      ...
                      <TableCell>
                        <ActionButtons
                          ...
                          onDelete={() =>
                            console.log("Delete coach:", coach._id)
                          }
